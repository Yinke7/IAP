...
//	DEV_Delay_ms(100);
    ...
    Paint_DrawFloatNum(5, 150, 12.56, 5, &Font20, WHITE, LIGHTBLUE);
    Paint_DrawString_EN(5, 170, "WaveShare", &Font24, WHITE, BLUE);
    Paint_DrawString_CN(5, 190, "微雪电子", &Font24CN, WHITE, RED);
...
void LCD_2in4_test_init(void) {
    Debug("LCD_2IN4_test Demo\r\n");
    DEV_Module_Init();

    Debug("LCD_2IN4_ Init and Clear...\r\n");
    LCD_2IN4_Init();
    LCD_2IN4_Clear(WHITE);

    Debug("Paint_NewImage\r\n");
    Debug("WidthByte = %d, HeightByte = %d\r\n", LCD_2IN4_WIDTH, LCD_2IN4_HEIGHT);
    Paint_NewImage(LCD_2IN4_WIDTH, LCD_2IN4_HEIGHT, ROTATE_0, WHITE);

    Debug("Set Clear and Display Funtion\r\n");
    Paint_SetClearFuntion(LCD_2IN4_Clear);
    Paint_SetDisplayFuntion(LCD_2IN4_DrawPaint);
