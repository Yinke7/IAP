...
#define FLASH_UPDATE_PARA_ADDR              (0x08000000 + 0x3F000)      //升级设置
#define FLASH_APP_CODE_ADDR                 (0x08000000 + 0x10000)       //APP程序地址


#define __DEBUG_DRIVERS__           0
#define __DEBUG_BREAK_ERR__         1               //0：测试过程中有测试项不通过时继续测试 1：测试过程中有测试项不通过时结束测试

#define __SPI_USE_SOFTWARE__        1               //0：SPI软件模拟 1：SPI硬件外设
